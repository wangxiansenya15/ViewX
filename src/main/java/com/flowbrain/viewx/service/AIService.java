 ...
 * Note: This assumes spring-ai-openai is used, but implementing via
 * RestTemplate for portability if dependency is missing.
 */
@Service
public class AIService {
    ...
    public Result<Map<String, Object>> analyzeVideoContent(String title, String description) {
        if (apiKey == null || apiKey.isEmpty()) {
            return Result.serverError("配置错误: AI API Key 未配置");
        }
        ...
        try {
            ...
            request.put("messages", List.of(
                    Map.of("role", "system", "content",
                            "You are a helpful AI assistant for video content analysis. Always return valid JSON."),
            ...
            return Result.serverError("AI API 返回空响应");

        } catch (Exception e) {
            return Result.serverError("AI 分析失败: " + e.getMessage());
        }
    }
